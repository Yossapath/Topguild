...
`;
if (!index.includes('.btn-solid-blue')) {
...
// Let's replace the inner flex perfectly
const innerRegex = /<div style="display: flex; flex-direction: row; width: 100%; max-width: 1000px; padding: 40px 20px; gap: 80px; align-items: center; justify-content: center; flex-wrap: wrap; margin: auto;">/;
if (innerRegex.test(index)) {
    index = index.replace(innerRegex, `<div style="display: flex; flex-direction: row; width: 100%; max-width: 1000px; padding: 40px 20px; gap: 80px; align-items: center; justify-content: center; flex-wrap: wrap; margin: 0 auto; position: relative;">`);
}
