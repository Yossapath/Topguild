...
const renderFuncStart = code.indexOf('window.renderAdminUsers = function() {');
const renderFuncEnd = code.indexOf('};', renderFuncStart) + 2;
...
code = code.substring(0, renderFuncStart) + newRenderFunc + code.substring(renderFuncEnd);

// Also need to fix the sort logic in fetchAndRenderUsers to normalize the role before sorting!
...
console.log('Fixed renderAdminUsers layout and sort role case!');
